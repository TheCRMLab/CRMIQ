namespace Cobalt.Components.CrmIQ.Plugin
{
    ...
    public partial class FetchXmlExpression
    {
        ...
        public static FetchXmlExpression Deserialize(string xml)
        {
            ...
            return (FetchXmlExpression)serializer.Deserialize(reader);
        }
    ...
    public partial class savedqueryFetchxml
    {
        ...
        private FetchXmlExpression fetchField;

        /// <remarks/>
        public FetchXmlExpression fetch
        {
            get
            {
